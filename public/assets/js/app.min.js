...
!(function (a) {
    ...
    (function (c) {
        ...
        (t.prototype.send = function (t, e, a, i, o, n, r, s) {
            var d = { heading: t, text: e, position: a, loaderBg: i, icon: o, hideAfter: (n = n || 3e3), stack: (r = r || 1) };
        ...
        (t.prototype.activateDefaultSidebarTheme = function () {
            ...
            (t.prototype.init = function () {
                e.LayoutThemeApp.init(),
                    ...
                    e.RightBar.init(),
                    window.sessionStorage && (sessionStorage.getItem("_HYPER_VISITED_") || (e.RightBar.toggleRightSideBar(), sessionStorage.setItem("_HYPER_VISITED_", !0)));
                e.Portlet.init(),
    ...
    (function () {
        "use strict";
        // sessionStorage.setItem('_HYPER_CONFIG_', JSON.stringify({
        //     "sideBarTheme": "light",
        //     "isBoxed": false,
        //     "isCondensed": false,
        //     "isScrollable": false,
        ...
        sessionStorage.removeItem('_HYPER_VISITED_');
