...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'fam_order' => 'anak ke',
        'fam_count' => 'jumlah bersaudara',
        'fam_status' => 'status keluarga',
        'language' => 'bahasa',
        'address' => 'alamat',
        'phone' => 'no handphone',
        'live_with' => 'tinggal dengan',
        'residence_distance' => 'jarak rumah ke sekolah',
        'blood_type' => 'golongan darah',
        'sick_history' => 'riwayat penyakit',
        'height' => 'tinggi',
        'weight' => 'berat',
        'graduate_from' => 'lulusan dari',
        'ijazah_year' => 'tahun ijazah',
        'ijazah_sd_no' => 'no ijazah sd',
        'skhu_no' => 'no skhu',
        'move_from' => 'pindahan dari',
        'receive_at_grade_id' => 'diterima di kelas',
        ...
        'work' => 'pekerjaan',
        'died_at' => 'meninggal pada',
        'monthly_income' => 'pendapatan perbulan',
