                ...
                <form action="{{route('students.index')}}" method="get">
                    <div class="form-group d-flex" style="gap:1rem">
                        ...
                        <div class="d-flex justify-content-between align-items-center" style="gap:1rem">
                            ...
                            @if(request('query'))
                            <a href="{{route('students.index')}}" class="btn btn-sm btn-warning btn-rounded"><i class="dripicons-clockwise"></i></a>
                            @endif
                        </div>
                    </div>
                </form>
                ...
                <div class="table-responsive shadow-sm">
                    <table class="table table-sm table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-nowrap">{{optional($student->grade)->code ?? ''}} - {{optional($student->grade)->name ?? ''}}</td>
                                ...
                                <td class="text-nowrap">{{optional($student->receiveAtGrade)->code ?? ''}} - {{optional($student->receiveAtGrade)->name ?? ''}}</td>
