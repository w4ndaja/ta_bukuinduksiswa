                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row m-0 p-0">
                            ...
                            <span class="col">: {{optional($student->grade)->code}} - {{optional($student->grade)->name}}</span>
                        </div>
                        <div class="form-group row m-0 p-0">
                        ...
                        <div class="form-group row m-0 p-0">
                            ...
                            <span class="col">: {{optional($student->receiveAtGrade)->code}} - {{optional($student->receiveAtGrade)->name}}</span>
                        </div>
                        <div class="form-group row m-0 p-0">
